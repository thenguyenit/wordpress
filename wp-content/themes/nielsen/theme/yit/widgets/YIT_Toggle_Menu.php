...
if ( ! class_exists( 'YIT_Toggle_Menu' ) ) :
    ...
    class YIT_Toggle_Menu extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'menu' ) ); ?>"><?php _e( 'Menu', 'yit' ) ?></label>
                <select id="<?php echo esc_attr( $this->get_field_id( 'menu' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'menu' ) ); ?>">
                    <?php foreach ( yit_get_registered_nav_menus() as $menu ): ?>
                        <option value="<?php echo esc_attr( $menu ) ?>" <?php selected( $instance['menu'], $menu ) ?>><?php echo $menu ?></option>
                    <?php endforeach ?>
                </select>
            ...
            <p>
                <input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'open_dropdowns' ) ); ?>" value="first" <?php checked( 'first', $instance['open_dropdowns'] ) ?> />
                <label><?php _e( 'Open the first dropdown', 'yit' ) ?></label><br />

                <input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'open_dropdowns' ) ); ?>" value="all" <?php checked( 'all', $instance['open_dropdowns'] ) ?> />
                <label><?php _e( 'Open all dropdowns', 'yit' ) ?></label><br />

                <input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'open_dropdowns' ) ); ?>" value="active" <?php checked( 'active', $instance['open_dropdowns'] ) ?> />
                <label><?php _e( 'Open active dropdown', 'yit' ) ?></label><br />

                <input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'open_dropdowns' ) ); ?>" value="none" <?php checked( 'none', $instance['open_dropdowns'] ) ?> />
