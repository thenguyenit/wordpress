...
$theme_shortcodes = array(
    ...
    'teaser'       => array(
        ...
        'attributes'         => array(
            ...
            'hyperlink' => array(
                'title' => __( 'Make banner clickable( not only the button )', 'yit' ),
                'type' => 'checkbox',
                'std' => 'yes'
            ),
