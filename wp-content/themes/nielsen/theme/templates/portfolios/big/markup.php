...
<div class="portfolio-<?php echo esc_attr( $layout ) ?>">
    ...
    <ul id="portfolio_big" class="wrapper">
        ...
        while ( $portfolio->have_posts() ) : $portfolio->the_post();
            ...
            $classes            = "filterable_item border";
            ...
            <li <?php $portfolio->item_class( $classes )?> >
                <div class="row">
                    ...
                    <div class="info <?php echo $show_thumbnail ? 'col-sm-6' : 'col-sm-12 no-thumb';?>">
                        <?php if ( $enable_title ) : ?>
                            <h3 class="title">
                                <a class="title_link" href="<?php echo esc_url( $portfolio->get( 'permalink' ) ); ?>"><?php echo $title; ?></a>
                            </h3>
                        <?php endif; ?>
