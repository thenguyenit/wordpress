...
<div id="<?php echo esc_attr( $slider_id ) ?>"<?php $slider->item_class($slider_class) ?> style="<?php echo esc_attr( $width_inline.$height_inline ); ?>">

    <div class="slider-wrapper"
         data-animation="<?php echo esc_attr( $effect ); ?>"
         data-slideshow-speed="<?php echo esc_attr( $interval ) ?>"
         data-animation-speed="<?php echo esc_attr( $speed ) ?>"
         data-touch="false"
         data-control-nav="<?php echo esc_attr( $controlnav != '' ? $controlnav : 'false' ) ?>"
         data-prev-text=""
         data-next-text="">
