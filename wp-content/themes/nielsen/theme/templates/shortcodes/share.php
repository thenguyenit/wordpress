...
$socials_accepted = array( 'facebook', 'twitter', 'google', 'pinterest','email');
                ...
                foreach ( $socials as $i => $social ) {
                    if ( in_array( $social, $socials_accepted ) ) {
                        ...
                        if ( $social == 'facebook' ) {
                            ...
                            $social = 'envelope-o';
                            $social_name = __('Share by Mail', 'yit') ;
                        ...
                        echo do_shortcode( '[social icon_type="'.$icon_type.'"  icon_social="' . $social . '" href="' . $url . '"' . $attrs . ' target="_blank" size="' . $size . '" icon_size="'.$icon_size.'" circle="yes" circle_size="'.$circle_size.'" circle_border_size="1" title="'.$social_name.'"]' );
                        echo $script;
                    }
                }
