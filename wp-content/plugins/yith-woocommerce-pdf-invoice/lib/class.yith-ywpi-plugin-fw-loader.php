	...
	class YITH_YWPI_Plugin_FW_Loader {
		...
		public function register_pointer() {
			...
			$premium_message = defined( 'YITH_YWPI_PREMIUM' )
				? ''
				: __( 'YITH WooCommerce PDF Invoice and Shipping List is available in an outstanding PREMIUM version with many new options, discover it now.', 'yith-woocommerce-pdf-invoice' ) .
			...
			$args[] = array(
				...
				'content'    => sprintf( '<h3> %s </h3> <p> %s </p>',
					__( 'YITH WooCommerce PDF Invoice and Shipping List', 'yith-woocommerce-pdf-invoice' ),
					__( 'In YIT Plugins tab you can find YITH WooCommerce PDF Invoice and Shipping List options.<br> From this menu you can access all settings of YITH plugins activated.', 'yith-woocommerce-pdf-invoice' ) . '<br>' . $premium_message
				),
